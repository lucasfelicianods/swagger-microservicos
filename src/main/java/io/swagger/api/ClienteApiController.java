...
public class ClienteApiController implements ClienteApi {
	...
	@Override
	public ResponseEntity<Cliente> alterarStatusPorId(String status, Integer id) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ResponseEntity<Cliente> casdastraNovo(Cliente cliente) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ResponseEntity<Void> excluiExiste(Integer id) {
		// TODO Auto-generated method stub
		return null;
	}
