...
public class Cliente   {
   ...
   * @return id
  **/
  @ApiModelProperty(value = "Indentificador do cliente.")
...
@Size(min=2,max=7) 
  ...
  **/
  ...
  /**
   * Data de atualizacao dos dados do cliente.
   * @return dataAtualizacao
  **/
  @ApiModelProperty(value = "Data de atualizacao dos dados do cliente.")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Status do cliente ativo ou inativo.")
